...
exports.fetchTableRecords = (0, toolkit_1.createAsyncThunk)("tables/fetchRecords", function (_a, thunkAPI_1) { return __awaiter(void 0, [_a, thunkAPI_1], void 0, function (_b, thunkAPI) {
    var state, tableId, altan_db, response;
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                altan_db = (0, axios_1.createAltanDB)();
                return [4 /*yield*/, altan_db.post("/table/".concat(tableId, "/record/query"), {
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!tableId)
                    throw new Error("Table ".concat(tableName, " not found"));
                altan_db = (0, axios_1.createAltanDB)();
                return [4 /*yield*/, altan_db.post("/table/".concat(tableId, "/record"), {
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!tableId)
                    throw new Error("Table ".concat(tableName, " not found"));
                altan_db = (0, axios_1.createAltanDB)();
                return [4 /*yield*/, altan_db.patch("/table/".concat(tableId, "/record/").concat(recordId), {
                        fields: updates
                    })];
            case 1:
                response = _c.sent();
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!tableId)
                    throw new Error("Table ".concat(tableName, " not found"));
                altan_db = (0, axios_1.createAltanDB)();
                return [4 /*yield*/, altan_db.delete("/table/".concat(tableId, "/record/").concat(recordId))];
            case 1:
                _c.sent();
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!tableId)
                    throw new Error("Table ".concat(tableName, " not found"));
                altan_db = (0, axios_1.createAltanDB)();
                return [4 /*yield*/, altan_db.get("/table/".concat(tableId))];
            case 1:
                response = _c.sent();
...
var tablesSlice = (0, toolkit_1.createSlice)({
    ...
    reducers: {
        initializeTables: function (state) {
            var SAMPLE_TABLES = (0, config_1.getDatabaseConfig)().SAMPLE_TABLES;
